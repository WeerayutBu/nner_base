...
if __name__ == "__main__":
    TestCase1 = ['S-M', 'I-X', 'I-X', 'O']

    # Test case2
    TestCase2 = ['O', 'O','B-MEA', 'E-MEA']
    TestCase2 = fix_labels(TestCase1, ["BIOES", "BIO"][0],visualize=False)
    if TestCase2 != ['O', 'O', 'B-MEA', 'E-MEA']:
        print("!!! TestCase2", TestCase2)

    print(remove_incorrect_tag(["S-NE", "B-NE", "S-NE"], tag_type="BIOES"))
    print(remove_incorrect_tag(["B-NE", "I-NE", "E-NE"], tag_type="BIOES"))
    print(remove_incorrect_tag(["S-NE", "B-NE", "E-NE"], tag_type="BIOES"))
    breakpoint()
    """[Don't foget to check the last label]"""