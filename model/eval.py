...
group3 = ['religion', 'nickname', 'book', 'language', 'river',  'continent',  'restaurant',  'state',  'psudoname',  'address', 'electronics', 'weapon',  'hospital', 'natural_disaster', 'jargon',  'product_food', 'distance', 'island',  'building', 'fund', 'animal_species',  'nicknametitle',  'sciname', 'food_ingredient', 'tv_show', 'hotel',  'vehicle', 'org_religious',  'bridge',  'soi', 'periodic', 'airport', 'middle',  'station', 'namemod', 'song', 'mountian', 'film', 'weight',  'award',  'ocean',  'space',  'energy',  'product_drug', 'port', 'museum',  'god', 'woa', 'stadium', 'fold', 'sports_event', 'war', 'animate', 'band', 'season',  'stock_exchange',  'game', 'postcode', 'sports_team', 'temperature', 'index',  'longtitude',  'latitude', 'concert', 'speed']
