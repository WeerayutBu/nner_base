...
from .features_lm_input import InputLM
from .features_conll_labels import CONLLLabels

class NERDataloader():
    
    def __init__(self, 
        path_data, lm_path, 
        max_sent_length, boundary_type, 
    ...
    def _gen_dict(self):
        ...
        # Generate boundary tags
        boundary_type=copy.deepcopy(self.boundary_type)
...
if __name__ == "__main__":
    dataset = NERDataloader(
        path_data = "resources/data/chula_ner/",
    ...
    for batch in dataset.get_train(): break
    print(batch.keys())
